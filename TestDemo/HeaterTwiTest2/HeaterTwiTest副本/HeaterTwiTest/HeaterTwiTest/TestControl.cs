...
namespace SFPXFP自动测试软件多端口
{
    ...
    public class TestControl
    {
        ...
        private string sencheck(string pssch)
        {
            ...
            try
            {
                Status = pssbert.GetChannelStatus(pssch);
                result.message = "灵敏度测试：" + Status;
                ModListBoxShow(this, result);
                ...
                if (Status.Contains("Y Y"))//误码
                {
                    ...
                    if (fpn.Contains("T5-"))
                    {
                        numnew = Convert.ToDouble(Status.Substring(21, 11).Trim());//22
                        if (numnew <= num25G)
                        {
                            //灵敏度测试PASS
                        }
                ...
                else if (Status.Contains("Y N"))//同步
                {
                    ...
                    if (fpn.Contains("T5-"))
                    {
                        numnew = Convert.ToDouble(Status.Substring(22, 10).Trim());//22
                        if (numnew <= num25G)
                        {
                            //灵敏度测试PASS
                        }
