...
namespace FibertopTest_Common
{
    ...
    public class TestSet
    {
        ...
        //----- 从数据库读取的默认调试参数（初始搜索范围）-----//
        // 这些值在LoadParamSet()中从Access数据库ModuleType表读取，
        // 作为二分法/线性搜索的初始搜索范围起点。
        ...
        public static UInt16 txcpa_Min_def = 40;
        public static UInt16 txcpa_Max_def = 60;
        public static UInt16 tosatemp_min_def = 830;
        public static UInt16 tosatemp_max_def = 1830;

        //----- 精度参数 -----//
        public static float txer_prec = 0.5f;     // 消光比精度(dB)
        public static float txPwr_prec = 0.5f;    // 发射光功率精度(dBm)
        public static float rxPwr_prec = 0.5f;    // 接收光功率精度(dBm)
        public static float wlgth_prec = 0.1f;    // 波长精度(nm)
        public static float wlgth_err = 0.5f;     // 波长误差允许(nm)

        //----- 设备延时(ms/100ms单位) -----//
        public static UInt16 delay_doa = 5;       // DOA(光衰减器)稳定延时
        public static UInt16 delay_opm = 5;       // OPM(光功率计)读取延时
        public static UInt16 delay_pssbert = 5;   // BERT(误码仪)稳定延时

        //----- 测试项目使能标志（从数据库读取"Y"/"N"）-----//
        public static string test_rx = "Y";
        public static string test_rxnopwr = "Y";
        public static string test_tx = "Y";
        public static string test_txnopwr = "Y";
        public static string test_txdishw = "Y";
        public static string test_rxloshw = "Y";
        public static string test_sen = "Y";
        public static string test_25galg = "N";
        public static string test_cobld = "N";
        public static string test_eml = "N";
        public static string test_apd = "N";
        public static string test_coppersfp = "N";
        public static string test_cdrdis = "N";
        public static string test_schemedis = "N";
        public static string test_init = "Y";
        public static string test_rosa_pin = "N";
    }
