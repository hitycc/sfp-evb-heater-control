...
namespace FibertopTest_Common
{
    ...
    public class SfpDriverAdapter : IModuleDriver
    {
        ...
        public ushort ReadRxADC(int ch)
        {
            return _sfp.GetRxADC();
        }

        public bool SetAPD(int ch, ushort dacValue)
        {
            return _sfp.SetAPD(dacValue);
        }
        ...
        {
            return _sfp.GetDDMAnalogValues();
        }

        public bool GetDDMFlagsInterrupt()
        {
            return _sfp.GetDDMFlagsInterrupt();
        }

        public bool EEPROMCheckSum()
        {
            return _sfp.EEPROMcheckSum();
        }
