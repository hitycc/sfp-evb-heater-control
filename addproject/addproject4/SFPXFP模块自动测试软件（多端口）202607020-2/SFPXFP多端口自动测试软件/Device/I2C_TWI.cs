...
namespace FibertopTest_Common
{
    public class TWI : I2C
    {
        ...
        private const int ms_Delay = 7; //ms
        ...
        int WriteBuf(byte waddr, byte[] data, uint wlen)
        {
          ...
          POS_STP:
            ...
            if (GlobalVarFun.moduleType == "SFPP-GN1196" || GlobalVarFun.moduleType == "SFP-GN25L95" || GlobalVarFun.moduleType == "SFP-GN25L96" || GlobalVarFun.moduleType == "SFP-UX3320C"
                || GlobalVarFun.moduleType == "SFP-UX3320T" || GlobalVarFun.moduleType == "SFPP-UX3261S" || GlobalVarFun.moduleType == "SFPP-UX2270+2072")
            {
                Thread.Sleep(8); //针对GN25L95/GN25L96/UX3320C/UX3320T写操作增加延时6ms
            }
