...
namespace SFPXFP自动测试软件多端口
{
    public partial class SetupFrm : Form
    {
        ...
        private bool RxAutoCheckStup()
        {
            ...
            TestControl.otp12.SW_SetRouteForModule(1, true);
        ...
        private bool RxAutoCheckStup2()
        {
            ...
            //MessageBox.Show("check1 result.OutPower：" + result.OutPower.ToString());
            ...
            //MessageBox.Show("光源2tarpwr："+ tarpwr.ToString());
            var result2 = MeasureAttenuation(TestControl.otp12, 2, tarpwr);
            att = result2.Attenuation;
            TestSet2.rxPwr_Cal[1] = result2.OutPower;
            //MessageBox.Show("check2 result2.OutPower：" + result2.OutPower.ToString());
            ...
            //MessageBox.Show("check3 result3.OutPower：" + result3.OutPower.ToString());
            ...
            TestControl.otp12.SW_SetRouteForModule(2, true);
        ...
        private bool RxAutoCheckStup3()
        {
            ...
            TestControl.otp12.SW_SetRouteForModule(3, true);
        ...
        private bool RxAutoCheckStup4()
        {
            ...
            //OTP12设备设置
            TestControl.otp12.SW_SetRouteForModule(4, true);
