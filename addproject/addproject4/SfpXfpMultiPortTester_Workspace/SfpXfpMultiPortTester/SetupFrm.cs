...
namespace SfpXfpMultiPortTester
{
    public partial class SetupFrm : Form
    {
        ...
        private bool RxAutoCheckStup()
        {
            ...
            TestSet.rxPwr_Cal[0] = TestControl.opticalmeter.ReadPower(GlobalVarFun.setup.meter_ch_a,GlobalVarFun.setup.meter_delay);// TestControl.opticalmeter.ReadPower(GlobalVarFun.setup.meter_ch_a,GlobalVarFun.setup.meter_delay);
            ...
            //overload
            tarpwr = TestResult.rxOverLoad;//Convert.ToSingle(textBox_overLoad.Text);
            att = AutoSetDOA(tarpwr);
            ...
            //sen
            tarpwr = TestResult.rxSen;//Convert.ToSingle(textBox_Sen.Text);
            att = AutoSetDOA(tarpwr);
            rxpwr = TestControl.opticalmeter.ReadPower(GlobalVarFun.setup.meter_ch_a,GlobalVarFun.setup.meter_delay);
            err = tarpwr - rxpwr;
            if (Math.Abs(err) > 0.2) return false;
            ...
            DOA.rxSenAtt = att;
            //D_los
            tarpwr = TestResult.rxDLos;//Convert.ToSingle(textBox_DLos.Text);
            att = AutoSetDOA(tarpwr);
            rxpwr = TestControl.opticalmeter.ReadPower(GlobalVarFun.setup.meter_ch_a,GlobalVarFun.setup.meter_delay);
            err = tarpwr - rxpwr;
            if (Math.Abs(err) > 0.2) return false;
            ...
            DOA.rxDLosAtt = att;
            //A_los
            tarpwr = TestResult.rxALos;//Convert.ToSingle(textBox_ALos.Text);
            att = AutoSetDOA(tarpwr);
            rxpwr = TestControl.opticalmeter.ReadPower(GlobalVarFun.setup.meter_ch_a,GlobalVarFun.setup.meter_delay);
            err = tarpwr - rxpwr;
            if (Math.Abs(err) > 0.2) return false;
        ...
        private bool RxAutoCheckStup2()
        {
            ...
            att = AutoSetDOA2(tarpwr);
            TestSet2.rxPwr_Cal[0] = TestControl.opticalmeter.ReadPower(GlobalVarFun.setup.meter_ch_b, GlobalVarFun.setup.meter_delay);// TestControl.opticalmeter.ReadPower(GlobalVarFun.setup.meter_ch_a,GlobalVarFun.setup.meter_delay);
            ...
            //overload
            tarpwr = TestResult2.rxOverLoad;//Convert.ToSingle(textBox_overLoad.Text);
            att = AutoSetDOA2(tarpwr);
            ...
            //sen
            tarpwr = TestResult2.rxSen;//Convert.ToSingle(textBox_Sen.Text);
            att = AutoSetDOA2(tarpwr);
            rxpwr = TestControl.opticalmeter.ReadPower(GlobalVarFun.setup.meter_ch_b, GlobalVarFun.setup.meter_delay);
            err = tarpwr - rxpwr;
            if (Math.Abs(err) > 0.2) return false;
            ...
            DOA2.rxSenAtt = att;
            //D_los
            tarpwr = TestResult2.rxDLos;//Convert.ToSingle(textBox_DLos.Text);
            att = AutoSetDOA2(tarpwr);
            rxpwr = TestControl.opticalmeter.ReadPower(GlobalVarFun.setup.meter_ch_b, GlobalVarFun.setup.meter_delay);
            err = tarpwr - rxpwr;
            if (Math.Abs(err) > 0.2) return false;
            ...
            DOA2.rxDLosAtt = att;
            //A_los
            tarpwr = TestResult2.rxALos;//Convert.ToSingle(textBox_ALos.Text);
            att = AutoSetDOA2(tarpwr);
            rxpwr = TestControl.opticalmeter.ReadPower(GlobalVarFun.setup.meter_ch_b, GlobalVarFun.setup.meter_delay);
            err = tarpwr - rxpwr;
            if (Math.Abs(err) > 0.2) return false;
